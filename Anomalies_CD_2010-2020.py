...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 16:58:41 2022
...
for i in range(surfaces_polynies_2010_2020.shape[0]) :
    ...
    elif (surfaces_polynies_2010_2020[i] > (2 - seuil)*Mean_surface_polynie_CD_2010_2020) :
...
print('Nombre de jours en dessus du seuil (~'+str(int((2-seuil)*100))+'%): ',compteur_max,'/',surfaces_polynies_2010_2020.shape[0])
...
md.plotMap_Anomalie(tp.sel_CapeDarnley(u10_Win_CD_around_seuil_ouverte_m), tp.sel_CapeDarnley(u10_Win_CD_around_seuil_fermee_m),
                    Liste_Vmin_Vmax=[-15,15],Liste_Vmin_Vmax_Delta=[-10,10],titre=['Polynie ouverte ('+str(compteur_min)+' j. ouverts / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
...
### Tracé Cape Darnley ###
md.plotMap_CapeDarnley(U10_Win_CD_around_seuil_fermee_m, dimension='$m.s^{-1}$',Liste_Vmin_Vmax=[0,15],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(U10_Win_CD_around_seuil_ouverte_m, dimension='$m.s^{-1}$',Liste_Vmin_Vmax=[0,15],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(U10_Win_CD_around_seuil_delta, dimension='$m.s^{-1}$',Liste_Vmin_Vmax=[-4,4],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))

md.plotMap_Anomalie(tp.sel_CapeDarnley(U10_Win_CD_around_seuil_ouverte_m), tp.sel_CapeDarnley(U10_Win_CD_around_seuil_fermee_m),
                    Liste_Vmin_Vmax=[0,15],Liste_Vmin_Vmax_Delta=[-10,10],titre=['Polynie ouverte ('+str(compteur_min)+' j. ouverts / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
                                                                                 'Polynie fermee ('+str(compteur_max)+' j. fermés / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
                                                                                 'Anomalie (= ouverte - fermee)'],
                    CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3)#,path_save='/gpfswork/rech/omr/uvc35ld/stage/IMAGES/Anomalies_CD/maps_U10_anomalie_OP_seuil_30_Sep_CD_2010-2020.png'
                    )
...
### Tracé Cape Darnley Around ###
md.plotMap_CapeDarnley_around(vo_Win_CD_around_seuil_fermee_m, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-3e-4,3e-4],CI_contour=CI_moyen,level_CI_contour=np.linspace(0.2,0.9,8))
...
### Tracé Cape Darnley ###
md.plotMap_CapeDarnley(vo_Win_CD_around_seuil_fermee_m, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-3e-4,3e-4],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(vo_Win_CD_around_seuil_ouverte_m, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-3e-4,3e-4],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(vo_Win_CD_around_seuil_delta, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-8e-5,8e-5],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
...
md.plotMap_Anomalie(tp.sel_CapeDarnley(vo_Win_CD_around_seuil_ouverte_m), tp.sel_CapeDarnley(vo_Win_CD_around_seuil_fermee_m),dimension=r"$s^{-1}$",
                    Liste_Vmin_Vmax=[-3e-4,3e-4],Liste_Vmin_Vmax_Delta=[-8e-5,8e-5],titre=['Polynie ouverte ('+str(compteur_min)+' j. ouverts / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
                                                                                 'Polynie fermee ('+str(compteur_max)+' j. fermés / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
                                                                                 'Anomalie (= ouverte - fermee)'],
                    CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3),
                    # path_save='/gpfswork/rech/omr/uvc35ld/stage/IMAGES/Anomalies_CD/maps_vo_anomalie_OP_seuil_30_Sep_CD_2010-2020.png'
                    )
...
### Tracé Cape Darnley ###
md.plotMap_CapeDarnley(d_Win_CD_around_seuil_fermee_m, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-3e-4,3e-4],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(d_Win_CD_around_seuil_ouverte_m, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-3e-4,3e-4],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
md.plotMap_CapeDarnley(d_Win_CD_around_seuil_delta, dimension='$s^{-1}$',Liste_Vmin_Vmax=[-8e-5,8e-5],CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3))
...
md.plotMap_Anomalie(tp.sel_CapeDarnley(d_Win_CD_around_seuil_ouverte_m), tp.sel_CapeDarnley(d_Win_CD_around_seuil_fermee_m),dimension=r"$s^{-1}$",
                    Liste_Vmin_Vmax=[-3e-4,3e-4],Liste_Vmin_Vmax_Delta=[-8e-5,8e-5],titre=['Polynie ouverte ('+str(compteur_min)+' j. ouverts / '+str(surfaces_polynies_2010_2020.shape[0])+' j.)',
                                                                                 ...
                                                                                 'Anomalie (= ouverte - fermee)'],
                    CI_contour=occurence_polynie_CD,level_CI_contour=np.linspace(0.2,0.6,3),
                    # path_save='/gpfswork/rech/omr/uvc35ld/stage/IMAGES/Anomalies_CD/maps_d_anomalie_OP_seuil_30_Sep_CD_2010-2020.png'
                    )
